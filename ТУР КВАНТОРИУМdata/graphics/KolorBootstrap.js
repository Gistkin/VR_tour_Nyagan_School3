...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'ТУР КВАНТОРИУМdata/ТУР КВАНТОРИУМ_messages_','.xml');
	krpanoLoaded = true;
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'ТУР КВАНТОРИУМdata/ТУР КВАНТОРИУМ_messages_','.xml');
}
...
function addKolorArea(pPlugID)
{
	...
	{
		var kolorAreaCSS = new ktools.CssStyle("KolorAreaCSS", crossDomainTargetUrl+"ТУР КВАНТОРИУМdata/graphics/KolorArea/kolorArea.css");
		var kolorAreaJS = new ktools.Script("KolorAreaJS", crossDomainTargetUrl+"ТУР КВАНТОРИУМdata/graphics/KolorArea/KolorArea.min.js", [], true);
